...
df_sensoren = pd.read_csv("/Users/noor/Bot4BACS/Sensoring/serial_test_backup1.csv")
...
df = df_truth.merge(df_sensoren, on='Time', how='inner')
...
df = df.round(4)
print(df)
df.to_csv("/Users/noor/Bot4BACS/Testo_Cal/Afternoon_data_new.csv", index=False)
